...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { to: '/documents', label: 'Documents', icon: (<svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M6 2h9l5 5v15H6z"/><path d="M14 2v6h6M9 13h8M9 17h8"/></svg>) },
    ],
  },
  {
    title: 'Communication',
