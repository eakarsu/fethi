...
export default function AiPhotoQualityScoringForListingsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/gap-ai-fethi/ai-photo-quality-scoring-for-listings', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI photo-quality scoring for listings</h1>
