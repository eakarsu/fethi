...
export default function PaymentProcessingEscrowPayoutsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/gap-nonai-fethi/payment-processing-escrow-payouts', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Payment processing (escrow, payouts)</h1>
