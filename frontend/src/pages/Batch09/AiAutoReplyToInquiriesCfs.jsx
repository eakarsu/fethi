...
export default function AiAutoReplyToInquiriesPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/custom/ai-auto-reply-to-inquiries', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI auto-reply to inquiries</h1>
