...
export default function PredictiveBookingSuccessAvailabilityPricingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/custom/predictive-booking-success-availability-pricing', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Predictive booking success (availability + pricing)</h1>
